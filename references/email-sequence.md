...
**For detailed templates**: See [references/sequence-templates.md](sequence-templates.md)
...
**For detailed email type reference**: See [references/email-types.md](email-types.md)
...
**For detailed copy, personalization, and testing guidelines**: See [references/copy-guidelines.md](copy-guidelines.md)
...
- **ai-cmo**: For overall content strategy, planning, and performance tracking
- **content-strategy**: For long-form content planning that email sequences can promote
- **marketing-psychology**: For psychological principles to apply in email copy and CTAs
- **analytics-tracking**: For measuring email performance and attribution
